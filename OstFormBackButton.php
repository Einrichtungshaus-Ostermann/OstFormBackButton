...
namespace OstFormBackButton;

use Shopware\Components\Plugin;
use Shopware\Components\Plugin\Context;
use Symfony\Component\DependencyInjection\ContainerBuilder;

class OstFormBackButton extends Plugin
{
    /**
     * ...
     *
    ...
    public function build(ContainerBuilder $container)
    {
        ...
        $container->setParameter('ost_form_back_button.plugin_dir', $this->getPath() . '/');
        $container->setParameter('ost_form_back_button.view_dir', $this->getPath() . '/Resources/views/');
